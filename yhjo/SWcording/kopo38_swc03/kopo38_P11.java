...
public class kopo38_P11 {
	...
	public static void main(String[] args) {
		...
		// 아래 버림)으로 설정
		// 남은 금액은 지불한 한화에서 환전된 금액과 수수료를 뺀 값이지만 이 경우 잔돈이 -값이 된다...
		System.out.printf("********************************************************************\n");
		...
		System.out.printf("********************************************************************\n");
		// 총 수수료는 kopo38_i_totalcom, 달러 환전 금액은 kopo38_usd, 달러당 수수료는 kopo38_ComPerOne이다.
		// 총 한화환전금액은 kopo38_MyWon, 달러 환전 금액은 kopo38_usd, 수수료 청구 금액은 kopo38_i_totalcom,
		// 최종 잔돈은 kopo38_remain이다.
	}
