...
public class kopo38_P02 {
	...
	public static void main(String[] args) {
		for (int kopo38_i = 1; kopo38_i < 4; kopo38_i++) {
			...
			System.out.printf("*************\t*************\t*************\n");
			// 1부터 시작해 4보다 작은 정수인 kopo38_i에 대해 kopo38_i에서 시작해 3씩 커지는 숫자를 이용해 구구단의 제목을 가로로
			// 배치한다.
			for (int kopo38_j = 1; kopo38_j < 10; kopo38_j++) {
				System.out.printf(" %d * %d = %2d \t %d * %d = %2d \t %d * %d = %2" + "" + "d \n", kopo38_i, kopo38_j,
						...
						(kopo38_i + 6) * kopo38_j);
				// 1부터 시작해 10보다 작은 정수 kopo38_j에 대해 kopo38_i와 가로로 이어지는 kopo38_i+3, kopo38_i+6에 대한
