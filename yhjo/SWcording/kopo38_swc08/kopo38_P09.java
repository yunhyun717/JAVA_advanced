...
public class kopo38_P09 {
	...
	public static void main(String[] args) throws IOException {
		...
		File kopo38_f1 = new File("C:\\Users\\yunhyun jo\\Documents\\kopo38_swc08_data\\day_data\\kopo38_SamsungStockPrice.csv");
		// File을 불러와 파일 경로를 통해 대상 파일을 지정한다.
		...
		while ((kopo38_readtxt = kopo38_br.readLine()) != null) {
			...
			if (kopo38_field[2].equals("A005930")) {
				// kopo38_field의 두번째 항목이 "A005930"과 같으면(종목 코드가 Samsung 코드와 같으면)
