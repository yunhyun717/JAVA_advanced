...
public class kopo38_P09_4 {
	...
	public static void kopo38_dataSort() {
		Comparator<kopo38_P09_1> kopo38_bikyeokijun = new Comparator<kopo38_P09_1>() {
			public int compare(kopo38_P09_1 kopo38_a1, kopo38_P09_1 kopo38_a2) {
				return (kopo38_a2.kopo38_sum() - kopo38_a1.kopo38_sum());
			}
		};
		Collections.sort(kopo38_ArrayOneRec, kopo38_bikyeokijun);
	}
	// 무엇을 기준으로(이 경우 sum 기준) sort할 것인지를 설정하고 ArrayList를 기준에 맞게 sort하는 메소드
	...
	// 최종 메인
	// 데이터를 생성하고 정렬, 이후 생성된 데이터를 설정한 페이지당 학생수에 따라 페이지를 출력한다.
